<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRegister.aspx.cs" Inherits="team_54.VendorRegister" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="com_name_reg" runat="server"></asp:TextBox>


            <asp:Label ID="Label5" runat="server" Text="bank account number"></asp:Label>
            <asp:TextBox ID="ban_acc_reg" runat="server"></asp:TextBox>

            <asp:Button ID="Button1" runat="server" Text="Register" onclick="vendor_register" Width="90px" />
